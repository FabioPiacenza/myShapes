...
usethis::use_git_config(
  scope = "project",
  user.name = "Fabio Piacenza",
  user.email = "f.piacenza1@campus.unimib.it"
)
usethis::use_git()
...
usethis::use_description(
  list(
    ...
    `Authors@R` = "person('Fabio', 'Piacenza', email = 'f.piacenza1@campus.unimib.it',
    role = c('cre', 'aut'))",
    Description = "This is a cool package.",
    URL = "https://github.com/FabioPiacenza/myShapes"
  )
)
